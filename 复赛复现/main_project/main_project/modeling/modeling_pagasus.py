...
class PegasusForConditionalGeneration(PegasusPreTrainedModel):
    ...
    def _super_get_resized_embeddings(self,
        ...
        """
        pad_token_data = old_embeddings.weight.data[0]
        unk_token_data = old_embeddings.weight.data[-1]
        cls_token_data = old_embeddings.weight.data[-2]
        sep_token_data = old_embeddings.weight.data[-3]
        mask_token_data = old_embeddings.weight.data[-4]
    ...
    def _get_resized_lm_head(self, old_tokenizer, new_tokenizer,
        ...
        get special token embedding from old embeddings
        """
        pad_token_data = old_lm_head.weight.data[0]
        unk_token_data = old_lm_head.weight.data[-1]
        cls_token_data = old_lm_head.weight.data[-2]
        sep_token_data = old_lm_head.weight.data[-3]
        mask_token_data = old_lm_head.weight.data[-4]
...
class PegasusForPretrain(PegasusPreTrainedModel):
