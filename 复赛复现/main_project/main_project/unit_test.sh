...
# 得到 精简vocab的bart-base模型
python pretrain/vocab/build_model.py --model_path ./pretrain/pretrain_model/bart-base-chinese \
    --save_path ./pretrain/pretrain_model/new-bart-base \
    --model_name bart
# 得到 精简vocab的bart-large模型
python pretrain/vocab/build_model.py --model_path ./pretrain/pretrain_model/bart-large-chinese \
    --save_path ./pretrain/pretrain_model/new-bart-large \
    --model_name bart
# 得到 精简vocab的cpt-base模型
python pretrain/vocab/build_model.py --model_path ./pretrain/pretrain_model/cpt-base \
    --save_path ./pretrain/pretrain_model/new-cpt-base \
    --model_name cpt
# 得到 精简vocab的cpt-large模型
python pretrain/vocab/build_model.py --model_path ./pretrain/pretrain_model/cpt-large \
    --save_path ./pretrain/pretrain_model/new-cpt-large \
    --model_name cpt
# 得到 精简vocab的pegasus模型
python pretrain/vocab/build_model.py --model_path ./pretrain/pretrain_model/Randeng-Pegasus-238M-Chinese \
    --save_path ./pretrain/pretrain_model/new-pegasus-base \
    --model_name pegasus

# 预训练 bart base dae
python pretrain/run_pretrain_bart_dae.py --total_epoch 1 \
    --batch_size 128 \
...
python pretrain/run_pretrain_bart_n_gram.py --total_epoch 1 \
    --batch_size 128 \
    --pretrain_model_path ./pretrain/pretrain_model/new-bart-base \
...
# 预训练 cpt base dae
python pretrain/run_pretrain_cpt_dae.py --total_epoch 1 \
    --batch_size 128 \
...
# 预训练 cpt base n-gram
python pretrain/run_pretrain_cpt_n_gram.py --total_epoch 1 \
    --batch_size 128 \
    --pretrain_model_path ./pretrain/pretrain_model/new-cpt-base \
...
python pretrain/run_pretrain_pegasus_dae.py --total_epoch 1 \
    --batch_size 32 \
...
python pretrain/run_pretrain_pegasus_gsg.py --total_epoch 1 \
    --batch_size 32 \
    --pretrain_model_path ./pretrain/pretrain_model/new-pegasus-base \
...
python finetune/run_finetune.py --seed 42 \
    ...
    --pretrain_model_path ./pretrain/pretrain_model/post-pretrained-bart-base-dae/epoch_1 \
    --model_name bart
# 微调 bart base n-gram
python finetune/run_finetune.py --seed 2023 \
    --smoothing 0.12 \
    --save_path ./finetune/finetune_models/bart_finetuned_model_base_n_gram \
    --pretrain_model_path ./pretrain/pretrain_model/post-pretrained-bart-base-n-gram/epoch_1 \
    --model_name bart
# 微调 bart large dae
python finetune/run_finetune.py --seed 1314 \
    --smoothing 0.15 \
    --save_path ./finetune/finetune_models/bart_finetuned_model_large_dae_eps0_15 \
    --pretrain_model_path ./pretrain/pretrain_model/post-pretrained-bart-large-dae/epoch_1 \
    --model_name bart
# 微调 bart large n-gram
python finetune/run_finetune.py --seed 2023 \
    --smoothing 0.12 \
    --save_path ./finetune/finetune_models/bart_finetuned_model_large_n_gram \
    --pretrain_model_path ./pretrain/pretrain_model/post-pretrained-bart-large-n-gram/epoch_1 \
    --model_name bart
...
python finetune/run_finetune.py --seed 42 \
    ...
    --pretrain_model_path ./pretrain/pretrain_model/post-pretrained-cpt-base-dae/epoch_1 \
    --model_name cpt
# 微调 cpt base n-gram
python finetune/run_finetune.py --seed 2023 \
    --smoothing 0.12 \
    --save_path ./finetune/finetune_models/cpt_finetuned_model_base_n_gram \
    --pretrain_model_path ./pretrain/pretrain_model/post-pretrained-cpt-base-n-gram/epoch_1 \
    --model_name cpt
# 微调 cpt large n-gram
python finetune/run_finetune.py --seed 123456 \
    --smoothing 0.15 \
    --save_path ./finetune/finetune_models/cpt_finetuned_model_large_n_gram_eps0_15 \
    --pretrain_model_path ./pretrain/pretrain_model/post-pretrained-cpt-large-n-gram/epoch_1 \
    --model_name cpt
...
python finetune/run_finetune.py --seed 42 \
    ...
    --pretrain_model_path ./pretrain/pretrain_model/post-pretrained-pegasus-base-dae/epoch_1 \
    --model_name pegasus
# 微调 pegasus base gsg
python finetune/run_finetune.py --seed 2023 \
    --smoothing 0.12 \
    --save_path ./finetune/finetune_models/pegasus_finetuned_model_base_gsg \
    --pretrain_model_path ./pretrain/pretrain_model/post-pretrained-pegasus-base-gsg/epoch_1 \
    --model_name pegasus
