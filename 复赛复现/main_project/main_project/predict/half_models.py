...
save_path_list = ['./predict/project/finetune_model/half_bart_finetuned_model_swa_large_ade_eps0_15_output',
                  './predict/project/finetune_model/half_bart_finetuned_model_swa_large_n-gram_output',

                  './predict/project/finetune_model/half_randeng_finetuned_model_swa_ade_output',
                  './predict/project/finetune_model/half_randeng_finetuned_model_swa_gsg_output',

                  './predict/project/finetune_model/half_cpt_finetuned_model_swa_large-n-gram-eps0_15_output']
